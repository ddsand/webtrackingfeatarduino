                ...
                <div class="row">                    
                    <div class="col-12">
                        <div class="card card-body">
                            ...
                            ?>
                            <form class="form-horizontal" action="<?=base_url()?>account/edit_process" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="inputID" placeholder="Username" name="username" value="<?=$row->username?>">
                                    </div>
                                </div>
                                <div class="form-group row">
